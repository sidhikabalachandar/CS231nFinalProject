...
def main():
    ...
    path_to_train = os.path.join(split_folder, folder_name, "small_train.txt")
    path_to_val   = os.path.join(split_folder, folder_name, "small_val.txt")
    path_to_test  = os.path.join(split_folder, folder_name, "small_test.txt")
    ...
    for path_to_category in paths_to_input_category:
        ...
        samples = [s for s in samples_of_category]
